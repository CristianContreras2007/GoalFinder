...
const BlackGirlsCode = () => {
  ...
  />
        ...
        <Text style={styles.mSText}>Black Girls Code is a nonprofit organization focused on providing young girls of color with the skills and opportunities to excel in technology. The program offers a range of activities, including coding workshops, hackathons, and summer camps. These sessions are designed to build technical skills, foster creativity, and encourage future careers in STEM fields. Participants gain hands-on experience with programming, app development, and other tech-related topics.
        </Text>
